...
<body>
<form method="post" action="newStatistic.jsp">
Choose statistic to display, start date, and end date.
Make sure your start and end dates are valid and that your end date occurs after your start date,
